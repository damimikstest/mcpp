...
Matrix Matrix::operator*(Matrix &ref){
	...
	cout << "New rows: " << (*this).rows << endl << "New columns: " << ref.retdim() << endl;
	if(retdim() == ref.rows){
...
int main()
{
	int option = 1;
	system("clear");
	cout << "What do you want to test?" << endl << "(1) vectors" << endl << "(2) matrices" << endl;
	cin >> option;
	if(option == 1){
		int mem = 2;
		Vector a(4);
	...
	if(option == 2){
		...
		cout << "▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀" << endl;
		cout << "A rows: " << A.retrows() << endl;
		cout << "A dim: " << A.retdim() << endl;
		cout << "B rows: " << B.retrows() << endl;
		cout << "B dim: " << B.retdim() << endl;		
		cout << "A + B:" << endl;
		cout << A << "+" << B << "=" << A + B;
		cout << "A - B:" << endl;
		cout << A << "-" << B << "=" << A - B;
